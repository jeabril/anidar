...
int main()
{
    ...
    do
    {
        ...
        case 5:
            //printf("\nListar empleados\n\n");
            printf("\nLegajo  Nombre  sexo   sueldo    fecha\n\n");
...
{
    eEmpleado empleado = {
            {1524,"Jessica",'f',50500,{18,10,1999},1},
            {3150,"Lautaro",'m',42500,{25,11,1998},1},
            {2365,"Matias",'m',32500,{05,06,1893},1},
            {7528,"Antonella",'f',15060,{16,04,2002},1}};
